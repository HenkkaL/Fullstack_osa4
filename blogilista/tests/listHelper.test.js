...
describe('total likes', () => {    
  ...
  describe('maximum likes', () => {    
    ...
    test('when several blogs returns the one with max likes', () => {    
        const result = listHelper.favoriteBlog(multipleBlogs)
        expect(result).toEqual(multipleBlogs[2])
    })

    test('when empty blogs returns null', () => {    
  ...
  describe('most blogs', () => {    
    ...
    test('when several blogs returns the correct authos', () => {    
  ...
  describe('most likes', () => {    
    ...
    test('when several blogs returns the correct author', () => {    
